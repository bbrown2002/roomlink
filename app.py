...
with st.sidebar:
    ...
    st.page_link("page/roommate_form.py", label="📝 Roommate Match Form", icon="🧑‍🤝‍🧑")
    st.page_link("page/match_results.py", label="🎯 Roommate Matches", icon="🎯")
    st.page_link("page/room_form.py", label="📬 Submit a Room Listing", icon="📦")
    st.page_link("page/housing_listings.py", label="🏡 View Housing Listings", icon="📍")
